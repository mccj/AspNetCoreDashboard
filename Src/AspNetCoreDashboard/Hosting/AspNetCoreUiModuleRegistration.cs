...
{
  internal sealed class AspNetCoreUiModuleRegistration : IUiModuleRegistration
  {
    private readonly UiModuleDescriptor _descriptor;

    public AspNetCoreUiModuleRegistration(UiModuleDescriptor descriptor)
    {
    ...
    {
      _descriptor.Routes.Add(new UiRouteEntry
      {
    ...
    internal void SetAuthorizationPolicy(string policyName)
    {
      _descriptor.AuthorizationPolicy = policyName;
    }
