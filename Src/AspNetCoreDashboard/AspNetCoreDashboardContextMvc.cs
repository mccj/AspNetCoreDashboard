...
{
    public class AspNetCoreDashboardContextMvc : DashboardContext
    {
        public AspNetCoreDashboardContextMvc(
            ...
            : base(/*storage, options*/)
        {
            ...
            Request = new AspNetCoreDashboardRequestMvc(httpContext);
            Response = new AspNetCoreDashboardResponseMvc(httpContext);
        }
    ...
    public class AspNetCoreDashboardContextMvc<T> : AspNetCoreDashboardContextMvc, IDashboardContext<T>
    {
        public AspNetCoreDashboardContextMvc([NotNull] T options, [NotNull] HttpContext httpContext) : base(httpContext)
        {
            Options = options;
        }
